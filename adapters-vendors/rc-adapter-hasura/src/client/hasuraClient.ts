...
export type HasuraClientConfiguration = {
    axiosInstance: any;
    structure: StoreNodeTypes;
};

interface IHasuraClient {
...
export class HasuraClient implements IHasuraClient {
    private axios: any;

    constructor(private config: HasuraClientConfiguration) {
