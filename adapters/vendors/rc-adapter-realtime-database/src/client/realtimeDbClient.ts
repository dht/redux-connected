...
export type RealtimeDbClientConfiguration = {
    axiosInstance: any;
    structure: StoreNodeTypes;
};

interface IRealtimeDbClient {
...
export class RealtimeDbClient implements IRealtimeDbClient {
    private axios: any;

    constructor(private config: RealtimeDbClientConfiguration) {
