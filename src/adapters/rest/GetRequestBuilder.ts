import { Filter, GetParams, FieldValue } from '../../types';
import { isEmpty, toArray } from 'shared-base';
import { GetRequestBuilderRules, rules } from './GetRulesBuilder';
...
export class GetRequestBuilder {
    ...
    build(): GetRequest {
        ...
        const { q, orderBy, filter, page, limit, slice, ...rest } =
            this.getParams;
